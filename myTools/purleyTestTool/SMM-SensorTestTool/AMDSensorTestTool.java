...
public class AMDSensorTestTool extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AMDSensorTestTool frame = new AMDSensorTestTool();
	 ...
	 * Create the frame.
	 */
	public AMDSensorTestTool() {
		setTitle("Sensor Test Tool For AMD");
		...
		comboBox_4.setToolTipText(
				"Sensor Name\u548CSensor ID\u4F1A\u81EA\u52A8\u4ECEBMC\u83B7\u53D6\u3002\r\n\u65F6\u95F4\u53EF\u80FD\u6709\u4E9B\u957F\u3002\r\n\u8BF7\u7A0D\u7B49\u3002");
		...
		lblNewLabel_3.setBounds(125, 0, 470, 15);
