...
public class RunMainTest extends AMDSensorTestTool implements Runnable, ActionListener{
	...
	class  RunIpmiCmd implements Runnable{
		...
		public void run() {
			...
			while(true) {
				...
				if(cmdString!=null) {
					this.rmt.setTitle("Sensor Test Tool For AMD -> 正在运行命令(还剩余"+ qquQueue.size() +"个)，请稍等。。。");
	...
	public void clickRunTest() {
		...
		if(response == 0) {
			runIpmiCmd.addcmd("ipmitool -H "+ comboBox.getSelectedItem() +" -U "+ comboBox_1.getSelectedItem() +" -P "+ comboBox_2.getSelectedItem() +" -I "+ comboBox_3.getSelectedItem() + " event \"" + comboBox_4.getSelectedItem().toString() + "\" list");
			if(sensorTypeThreshold) {
				...
				if(!lncString.equals(txtx.getText().toString())) {
					thresholdValueHashtable2.get(comboBox_4.getSelectedItem().toString())[1] = txtx.getText().toString();
					runIpmiCmd.addcmd("ipmitool -H "+ comboBox.getSelectedItem() +" -U "+ comboBox_1.getSelectedItem() +" -P "+ comboBox_2.getSelectedItem() +" -I "+ comboBox_3.getSelectedItem() + " -C 3 sensor thresh \"" + comboBox_4.getSelectedItem().toString() + "\" lnc " + txtx.getText().toString());
				}
				if(!lcString.equals(txtx_2.getText().toString())) {
					thresholdValueHashtable2.get(comboBox_4.getSelectedItem().toString())[2] = txtx_2.getText().toString();
					runIpmiCmd.addcmd("ipmitool -H "+ comboBox.getSelectedItem() +" -U "+ comboBox_1.getSelectedItem() +" -P "+ comboBox_2.getSelectedItem() +" -I "+ comboBox_3.getSelectedItem() + " -C 3 sensor thresh \"" + comboBox_4.getSelectedItem().toString() + "\" lc " + txtx_2.getText().toString());
				}
				if(!lcrString.equals(txtx_4.getText().toString())) {
					thresholdValueHashtable2.get(comboBox_4.getSelectedItem().toString())[3] = txtx_4.getText().toString();
					runIpmiCmd.addcmd("ipmitool -H "+ comboBox.getSelectedItem() +" -U "+ comboBox_1.getSelectedItem() +" -P "+ comboBox_2.getSelectedItem() +" -I "+ comboBox_3.getSelectedItem() + " -C 3 sensor thresh \"" + comboBox_4.getSelectedItem().toString() + "\" lcr " + txtx_4.getText().toString());
				}
				if(!uncString.equals(txtx_1.getText().toString())) {
					thresholdValueHashtable2.get(comboBox_4.getSelectedItem().toString())[4] = txtx_1.getText().toString();
					runIpmiCmd.addcmd("ipmitool -H "+ comboBox.getSelectedItem() +" -U "+ comboBox_1.getSelectedItem() +" -P "+ comboBox_2.getSelectedItem() +" -I "+ comboBox_3.getSelectedItem() + " -C 3 sensor thresh \"" + comboBox_4.getSelectedItem().toString() + "\" unc " + txtx_1.getText().toString());					
				}
				if(!ucString.equals(txtx_3.getText().toString())) {
					thresholdValueHashtable2.get(comboBox_4.getSelectedItem().toString())[5] = txtx_3.getText().toString();
					runIpmiCmd.addcmd("ipmitool -H "+ comboBox.getSelectedItem() +" -U "+ comboBox_1.getSelectedItem() +" -P "+ comboBox_2.getSelectedItem() +" -I "+ comboBox_3.getSelectedItem() + " -C 3 sensor thresh \"" + comboBox_4.getSelectedItem().toString() + "\" uc " + txtx_3.getText().toString());
				}
				if(!ucrString.equals(txtx_5.getText().toString())) {
					thresholdValueHashtable2.get(comboBox_4.getSelectedItem().toString())[6] = txtx_5.getText().toString();
					runIpmiCmd.addcmd("ipmitool -H "+ comboBox.getSelectedItem() +" -U "+ comboBox_1.getSelectedItem() +" -P "+ comboBox_2.getSelectedItem() +" -I "+ comboBox_3.getSelectedItem() + " -C 3 sensor thresh \"" + comboBox_4.getSelectedItem().toString() + "\" ucr " + txtx_5.getText().toString());
				}
			}else {
	...
	public void chooseSensorName() {
		...
		//this.setTitle("Sensor Test Tool For AMD -> 正在获取Sensor Name和SensorID, 请稍等...");
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						Process process2 = Runtime.getRuntime().exec("ipmitool -H "+ comboBox.getSelectedItem() +" -U "+ comboBox_1.getSelectedItem() +" -P "+ comboBox_2.getSelectedItem() +" -I "+ comboBox_3.getSelectedItem() + " -C 3 sdr get \"" + comboBox_4.getSelectedItem().toString() + "\"");
						new Thread(new Runnable() {
							...
							public void run() {
								...
								try {
									...
									thresholdValueHashtable2.put(comboBox_4.getSelectedItem().toString(), offsetStrings);
									...
									if(!thresholdValueHashtable.containsKey(comboBox_4.getSelectedItem().toString())) {
										thresholdValueHashtable.put(comboBox_5.getSelectedItem().toString(), line.split(" "));
										lblNewLabel_3.setText("LNC: "+offsetStrings[1] +",  LC: "+offsetStrings[2]+",  LCR: "+offsetStrings[3]+",  UNC: "+offsetStrings[4]+",  UC: "+offsetStrings[5]+",  UCR: "+offsetStrings[6]);
									}else {
										lblNewLabel_3.setText("LNC: "+offsetStrings[1] +",  LC: "+offsetStrings[2]+",  LCR: "+offsetStrings[3]+",  UNC: "+offsetStrings[4]+",  UC: "+offsetStrings[5]+",  UCR: "+offsetStrings[6]);
									}
